...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=same_package_name.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6b, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xb2, 0x01, 0x0a, 0x06, 0x4d, 0x65,
	...
	0x69, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x73, 0x61, 0x6d, 0x65, 0x5f,
	0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x2e, 0x4d, 0x65, 0x6d,
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: same_package_name.Memory.Unit
	(*Memory)(nil),   // 1: same_package_name.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: same_package_name.Memory.unit:type_name -> same_package_name.Memory.Unit
