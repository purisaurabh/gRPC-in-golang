...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=same_package_name.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x73, 0x61, 0x6d, 0x65, 0x5f, 0x70, 0x61,
	0x63, 0x6b, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f,
	...
	0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x73,
	0x61, 0x6d, 0x65, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x73, 0x61, 0x6d, 0x65, 0x5f, 0x70,
	0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x2e, 0x4d, 0x65, 0x6d, 0x6f,
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: same_package_name.Storage.Driver
	(*Storage)(nil),     // 1: same_package_name.Storage
	(*Memory)(nil),      // 2: same_package_name.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: same_package_name.Storage.driver:type_name -> same_package_name.Storage.Driver
	2, // 1: same_package_name.Storage.memory:type_name -> same_package_name.Memory
